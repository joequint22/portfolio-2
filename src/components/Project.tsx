...
const Project = (props: TProject) => {
  return (
      <div
        key={props.id}
        className="hover:scale-105 hover:shadow-lg border border-gray-700 hover:shadow-green-300 duration-500 flex flex-col justify-between text-center rounded-md"
      >
