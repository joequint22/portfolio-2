...
const Experience = () => {
  ...
  return (
    <div id="experience" className='bg-black w-full h-full lg:px-14 py-24'>

        <div className='max-w-screen-lg mx-auto p-4 xl:p-0 flex flex-col justify-center min-h-screen text-white'>
